                ...
                userInfo === null || userInfo === {} ?
                    <Header>
                        ...
                        <div className="signup">
                            <video className="bg__video" src="/videos/video-1.mp4" autoPlay loop muted />
                            <div className="signup__nav">
                                <Logo />
                                <h1>Join us to Search Github users !!</h1>
                            </div>
                            <div className="form">
                                ...
                                <div className="form__base">
                                    ...
                                    <div className="form__text">
                                        Already a user? <Link className="form__link" to="/">Sign in now.</Link>
                                    </div>
